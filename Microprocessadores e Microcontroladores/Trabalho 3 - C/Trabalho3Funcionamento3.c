...
unsigned char LerDadosAdC (void);
void LerPot (void);
void display (void);
...
// 	unsigned char leituraL;
// 	unsigned char soma_leitura;
	...
	leituraH= ADCH;
// 	leituraL=ADCL;
// 	soma_leitura=(leituraH<<8) + leituraL;
// 	return soma_leitura;
...
void LerPot (void)
{
	...
	i=0; //reset ao i para continuar o loop de leituras
